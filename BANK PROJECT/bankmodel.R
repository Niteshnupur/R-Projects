...
b_train = read.csv("C:\\Users\\Mr. Jarvis\\Desktop\\DATA SCIENCE PROJECT\\BANK PROJECT\\bank-full_train.csv", stringsAsFactors = FALSE)
...
b_test = read.csv("C:\\Users\\Mr. Jarvis\\Desktop\\DATA SCIENCE PROJECT\\BANK PROJECT\\bank-full_test.csv", stringsAsFactors = FALSE)
...
form =
  as.formula("
           y ~ balance + age_33_39 + age_39_48 + duration_LT_EQ_103 + 
...
write.csv(test.predicted,"Nitesh_Bhosle_P5_part2.csv",row.names = F)
